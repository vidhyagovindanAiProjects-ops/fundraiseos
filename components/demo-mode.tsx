...
function providerRegistry(context: ProviderContext): ProviderRegistryItem[] {
  return [
    ...
    { key: "csv", name: "CSV Provider", status: context.importedCount > 0 ? "Connected" : "Not Connected", label: "Imported Workspace Data", description: "Searches uploaded LP spreadsheets and CRM exports from My Fund Workspace.", capabilities: ["Search uploaded LP spreadsheets", "Search CRM exports", "Return imported workspace records"] },
    ...
    { key: "affinity", name: "Affinity Adapter", status: "Requires API credentials", label: "Requires API credentials", description: "Placeholder CRM adapter. Does not fabricate relationship data.", capabilities: ["Future relationship import", "Future warm intro search"] },
    { key: "attio", name: "Attio Adapter", status: "Requires API credentials", label: "Requires API credentials", description: "Placeholder CRM adapter. Does not fabricate relationship data.", capabilities: ["Future CRM import", "Future pipeline sync"] },
...
function activeProviderLabel(context: ProviderContext) {
  ...
  if (context.workspaceMode === "My Fund Workspace" && context.importedCount > 0) return { providerName: "CSV Provider", providerLabel: "Imported Workspace Data" as const, providerSummary: "CSV Provider is active; recommendations are grounded in uploaded LP spreadsheets and CRM exports." };
...
export function DemoMode() {
  ...
  return <div className="shell demo-shell story-shell ai-shell">
    <aside className={`sidebar ${menu ? "open" : ""}`}>
      ...
      <div className="demo-badge"><i />AI CHIEF OF STAFF</div>
